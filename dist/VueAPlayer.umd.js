...
__webpack_require__.r(__webpack_exports__);
      ...
      function render(_h, _vm) {
        var _c=_vm._c;return _c('svg',{class:[_vm.data.class, _vm.data.staticClass],style:([_vm.data.style, _vm.data.staticStyle]),attrs:{"xmlns":"http://www.w3.org/2000/svg","viewBox":"0 0 32 32"}},[_c('path',{attrs:{"d":"M25.468 6.947a1.004 1.004 0 00-1.03.057L18 11.384V7.831a1.001 1.001 0 00-1.562-.827l-12 8.164a1 1 0 000 1.654l12 8.168A.999.999 0 0018 24.164v-3.556l6.438 4.382A.999.999 0 0026 24.164V7.831c0-.371-.205-.71-.532-.884z"}})])
      }
...
__webpack_require__.r(__webpack_exports__);
      ...
      /* harmony default export */ __webpack_exports__["default"] = ({
        ...
        render: 
      function render(_h, _vm) {
        var _c=_vm._c;return _c('svg',{class:[_vm.data.class, _vm.data.staticClass],style:([_vm.data.style, _vm.data.staticStyle]),attrs:{"xmlns":"http://www.w3.org/2000/svg","viewBox":"0 0 32 32"}},[_c('path',{attrs:{"d":"M26.667 5.333H5.334h-.001a2.667 2.667 0 00-2.666 2.666V24.001a2.667 2.667 0 002.666 2.666h21.335a2.667 2.667 0 002.666-2.666V8v-.001a2.667 2.667 0 00-2.666-2.666h-.001zM5.333 16h5.333v2.667H5.333V16zm13.334 8H5.334v-2.667h13.333V24zm8 0h-5.333v-2.667h5.333V24zm0-5.333H13.334V16h13.333v2.667z"}})])
      }
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "APlayer", function() { return /* reexport */ components_APlayer; });
...
var vue_audio_VueAudio = /*#__PURE__*/function (_Vue) {
  ...
  var _super = _createSuper(VueAudio);
...
function vue_store_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (vue_store_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

function vue_store_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var vue_store_VueStore = /*#__PURE__*/function (_Vue) {
  ...
  var _super = vue_store_createSuper(VueStore);
...
function mixin_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (mixin_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

function mixin_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var mixin_Mixin = /*#__PURE__*/function (_Vue) {
  ...
  var _super = mixin_createSuper(Mixin);
...
function Cover_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (Cover_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

function Cover_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var Cover_Cover = /*#__PURE__*/function (_Vue$Component) {
  ...
  var _super = Cover_createSuper(Cover);
...
function Icon_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (Icon_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
...
function Lyric_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (Lyric_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

function Lyric_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var Lyric_Lyric = /*#__PURE__*/function (_Vue$Component) {
  ...
  var _super = Lyric_createSuper(Lyric);
...
function Main_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (Main_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
...
var Main_Main = /*#__PURE__*/function (_Vue$Component) {
  ...
  _createClass(Main, [{
    ...
    value: function render() {
      ...
      var _this$aplayer = this.aplayer,
          fixed = _this$aplayer.fixed,
          filled = _this$aplayer.filled;
      return h("div", {
        "class": "aplayer-info"
      }, [filled && !isMobile ? h(components_Cover) : null, h("div", {
        "class": "aplayer-music"
      }, [h("span", {
        "class": "aplayer-title"
      }, [music.name]), h("span", {
    ...
    get: function get() {
      var _this$aplayer2 = this.aplayer,
          currentMusic = _this$aplayer2.currentMusic,
          filled = _this$aplayer2.filled;
      var artist = currentMusic.artist;

      if (!filled) {
        artist = artist ? " - ".concat(artist) : 'akari';
      } else {
        artist = artist || 'akari';
      }
...
Main_Main = Main_decorate([vue_class_component_common_default()({
  mixins: [mixin]
})], Main_Main);
...
function vue_touch_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (vue_touch_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

function vue_touch_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var vue_touch_Touch = /*#__PURE__*/function (_Vue$Component) {
  ...
  var _super = vue_touch_createSuper(Touch);
...
function Button_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (Button_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
...
function Progress_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (Progress_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
...
function Controller_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (Controller_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
...
var Controller_Controller = /*#__PURE__*/function (_Vue$Component) {
  ...
  _createClass(Controller, [{
    ...
    value: function render() {
      ...
      return h("div", [filled && !isMobile ? h(components_Progress, {
        "class": "aplayer-bar-edge"
      }) : null, filled && !isMobile ? h("div", {
        "class": "aplayer-audio-control"
      }, [h("span", {
      ...
      }, [!filled || isMobile ? h(components_Progress) : null, h("div", {
        "class": "aplayer-time"
      }, [h("span", {
...
Controller_Controller = Controller_decorate([vue_class_component_common_default()({
  mixins: [mixin]
...
function Player_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (Player_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
  ...
  _createClass(Player, [{
    ...
    value: function render() {
      ...
      var playIcon = this.playIcon,
          notice = this.notice,
          isMobile = this.isMobile;
      var filled = this.aplayer.filled;
      return h("div", {
        "class": "aplayer-body"
      }, [!filled || isMobile ? h(components_Cover, {
        "on": {
          "click": this.handleTogglePlay
        }
      }, [h("div", {
      ...
      })])]) : null, h(components_Main, [h(components_Controller, {
        "on": {
...
Player_Player = Player_decorate([vue_class_component_common_default()({
  mixins: [mixin]
})], Player_Player);
...
function PlayList_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (PlayList_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

function PlayList_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var PlayList_a, PlayList_b, PlayList_c;
...
var PlayList_PlayList = /*#__PURE__*/function (_Vue$Component) {
  ...
  var _super = PlayList_createSuper(PlayList);
...
function APlayer_createSuper(Derived) { return function () { var Super = getPrototypeOf_getPrototypeOf(Derived), result; if (APlayer_isNativeReflectConstruct()) { var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

function APlayer_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var APlayer_a, APlayer_b, APlayer_c, APlayer_d, APlayer_e, _f, _g, _h;
...
var APlayer_APlayer = /*#__PURE__*/function (_Vue$Component) {
  ...
  var _super = APlayer_createSuper(APlayer);
  ...
  function APlayer() {
    ...
    _this = _super.apply(this, arguments); // 是否正在拖动进度条（防止抖动）

    _this.isDraggingProgressBar = false; // 是否正在等待进度条更新（防止抖动）

    _this.isAwaitChangeProgressBar = false; // 是否是迷你模式

    _this.isMini = _this.mini !== null ? _this.mini : _this.fixed && !_this.filled; // 是否是 arrow 模式
  ...
  _createClass(APlayer, [{
                ...
                case 4:
                  ...
                  reader.onload = function () {
                    ...
                    _this4.img.onload = function () {
                      var _ColorThief$getColor = new ColorThief().getColor(_this4.img),
                          _ColorThief$getColor2 = _slicedToArray(_ColorThief$getColor, 3),
                          r = _ColorThief$getColor2[0],
                          g = _ColorThief$getColor2[1],
                          b = _ColorThief$getColor2[2];
    ...
    value: function saveSettings(settings) {
      ...
      }) : [].concat(_toConsumableArray(this.settings), [settings]));
    } // #endregion
    // #region 事件处理
    // 切换上一曲
...
APlayer_decorate([Prop({
  ...
  required: false,
  default: false
}), APlayer_metadata("design:type", Boolean)], APlayer_APlayer.prototype, "filled", void 0);
...
function vue_aplayer_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }

function vue_aplayer_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { vue_aplayer_ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { vue_aplayer_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function install(Vue, options) {
  ...
  var opts = vue_aplayer_objectSpread({}, defaultOptions, {}, options);
  ...
  if (opts.productionTip) {
    // eslint-disable-next-line no-console
    console.log("%c vue-aplayer %c v".concat("2.0.0-beta.5", " ").concat("f71a754", " %c"), 'background: #35495e; padding: 1px; border-radius: 3px 0 0 3px; color: #fff', 'background: #41b883; padding: 1px; border-radius: 0 3px 3px 0; color: #fff', 'background: transparent');
  }
}
